...
public class UpdateFactoryService extends Service implements UpdateFactoryServiceCommand {
        ...
        public void update(Observable observable, Object o) {
            if(o instanceof UFService.SharedEvent) {
                ...
                if(newState.getStateName() == AbstractState.StateName.WAITING &&
                    ...
                    UpdateSystem.clearOtaUpdate();
                    UpdateSystem.clearApkUpdate(getApplicationContext());
                }
    ...
    private static final String ANDROID_BUILD_DATE_TARGET_ATTRIBUTE_KEY = "android_build_date";
    private static final String ANDROID_BUILD_TYPE_TARGET_ATTRIBUTE_KEY = "android_build_type";
    private static final String ANDROID_FINGERPRINT_TARGET_ATTRIBUTE_KEY = "android_fingerprint";
    private static final String ANDROID_KEYS_TARGET_ATTRIBUTE_KEY = "android_keys";
    private static final String ANDROID_VERSION_TARGET_ATTRIBUTE_KEY = "android_version";
    private static final String DEVICE_NAME_TARGET_ATTRIBUTE_KEY = "device_name";
    private static final String CLIENT_TYPE_TARGET_TOKEN_KEY = "client";
    private static final String CLIENT_DATE_TARGET_TOKEN_KEY = "date";
